...
interface BasicProps {
  ...
  templateProfileBasic: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    templateProfileBasic,
    loading: loading.effects['templateProfileBasic/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'templateProfileBasic/fetchBasic',
    });
  }

  render() {
    const { templateProfileBasic, loading } = this.props;
    const { basicGoods, basicProgress } = templateProfileBasic;
