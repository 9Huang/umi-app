...
@connect(
  ({
    templateProfileAdvanced,
    loading,
  }: {
    templateProfileAdvanced: AdvancedProfileData;
    loading: {
      effects: { [key: string]: boolean };
    };
  }) => ({
    templateProfileAdvanced,
    loading: loading.effects['templateProfileAdvanced/fetchAdvanced'],
  }),
)
class Advanced extends Component<
  { loading: boolean; templateProfileAdvanced: AdvancedProfileData; dispatch: Dispatch<any> },
  AdvancedState
> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'templateProfileAdvanced/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { templateProfileAdvanced, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = templateProfileAdvanced;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
