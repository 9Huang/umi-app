...
interface ApplicationsProps extends FormComponentProps {
  ...
  templateListSearchApplications: StateType;
  loading: boolean;
}
...
class Applications extends Component<ApplicationsProps> {
  componentDidMount() {
    ...
    dispatch({
      type: 'templateListSearchApplications/fetch',
      payload: {
        count: 8,
      },
    });
  ...
  render() {
    const {
      templateListSearchApplications: { list },
      loading,
      form,
    } = this.props;
...
export default connect(
  ({
    templateListSearchApplications,
    loading,
  }: {
    templateListSearchApplications: StateType;
    ...
    templateListSearchApplications,
    loading: loading.models.templateListSearchApplications,
  }),
)(WarpForm);
